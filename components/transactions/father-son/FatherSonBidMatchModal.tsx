  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent
        ...
        className={cn(
          "left-0 top-0 bg-black/20 backdrop-blur-sm flex h-full w-full max-w-none translate-x-0 translate-y-0 items-center justify-center border-0 p-6 pt-17.5 shadow-none outline-none",
