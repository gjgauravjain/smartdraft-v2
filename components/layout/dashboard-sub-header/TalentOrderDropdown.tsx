...
export function TalentOrderDropdown({
  ...
  return (
    <div className="flex items-center gap-2 border rounded-md h-8 py-0!">
      <SearchableDropdown
        value={value}
        options={options}
        onChange={onChange}
        ...
        triggerClassName="border-transparent  w-full min-w-[118px]  px-2 shadow-none bg-transparent! h-7 text-xs font-normal hover:bg-transparent focus:ring-0 focus:ring-offset-0 text-foreground!"
      />
    </div>
  );
}
